...
@Service
class NasaWebServiceImpl(val apodRepository: ApodRepository) : AbstractWebService(Constants.NASA_BASE_URL), NasaWebService {
    private val NASA_API_KEY = "YOUR_API_KEY"
